...
export class BigQueryWriteClient {
  ...
  initialize() {
    ...
    if (this.bigQueryWriteStub) {
      this.warn('DEP$BigQueryWrite', 'BigQueryWrite is deprecated and may be removed in a future version.', 'DeprecationWarning');
 ...
 */
  ...
  createWriteStream(
    ...
    this.warn('DEP$BigQueryWrite-$CreateWriteStream','CreateWriteStream is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    return this.innerApiCalls.createWriteStream(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IWriteStream,
        protos.google.cloud.bigquery.storage.v1beta2.ICreateWriteStreamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createWriteStream response %j', response);
 ...
 */
  ...
  getWriteStream(
    ...
    this.initialize().catch(err => {throw err});
    this.warn('DEP$BigQueryWrite-$GetWriteStream','GetWriteStream is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    return this.innerApiCalls.getWriteStream(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IWriteStream,
        protos.google.cloud.bigquery.storage.v1beta2.IGetWriteStreamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getWriteStream response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  finalizeWriteStream(
    ...
    this.initialize().catch(err => {throw err});
    this.warn('DEP$BigQueryWrite-$FinalizeWriteStream','FinalizeWriteStream is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    return this.innerApiCalls.finalizeWriteStream(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IFinalizeWriteStreamResponse,
        protos.google.cloud.bigquery.storage.v1beta2.IFinalizeWriteStreamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('finalizeWriteStream response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  batchCommitWriteStreams(
    ...
    this.initialize().catch(err => {throw err});
    this.warn('DEP$BigQueryWrite-$BatchCommitWriteStreams','BatchCommitWriteStreams is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    return this.innerApiCalls.batchCommitWriteStreams(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IBatchCommitWriteStreamsResponse,
        protos.google.cloud.bigquery.storage.v1beta2.IBatchCommitWriteStreamsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCommitWriteStreams response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  flushRows(
    ...
    this.initialize().catch(err => {throw err});
    this.warn('DEP$BigQueryWrite-$FlushRows','FlushRows is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    return this.innerApiCalls.flushRows(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IFlushRowsResponse,
        protos.google.cloud.bigquery.storage.v1beta2.IFlushRowsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('flushRows response %j', response);
        return [response, options, rawResponse];
 ...
 */
  appendRows(
    ...
    this.initialize().catch(err => {throw err});
    this.warn('DEP$BigQueryWrite-$AppendRows','AppendRows is deprecated and may be removed in a future version.', 'DeprecationWarning');
