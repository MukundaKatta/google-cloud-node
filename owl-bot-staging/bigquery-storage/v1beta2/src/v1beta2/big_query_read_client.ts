  ...
  createReadSession(
    ...
    return this.innerApiCalls.createReadSession(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.IReadSession,
        protos.google.cloud.bigquery.storage.v1beta2.ICreateReadSessionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createReadSession response %j', response);
 ...
 */
  ...
  splitReadStream(
    ...
    return this.innerApiCalls.splitReadStream(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta2.ISplitReadStreamResponse,
        protos.google.cloud.bigquery.storage.v1beta2.ISplitReadStreamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('splitReadStream response %j', response);
        return [response, options, rawResponse];
