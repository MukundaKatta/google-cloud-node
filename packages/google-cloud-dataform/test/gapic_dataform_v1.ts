...
describe('v1.DataformClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dataformModule.v1.DataformClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dataformModule.v1.DataformClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dataformModule.v1.DataformClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dataformModule.v1.DataformClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dataformModule.v1.DataformClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dataformModule.v1.DataformClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = dataformModule.v1.DataformClient.port;
            assert(port);
    ...
    describe('getTeamFolder', () => {
        it('invokes getTeamFolder without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetTeamFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetTeamFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.TeamFolder()
            );
        ...
        it('invokes getTeamFolder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTeamFolder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ITeamFolder|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTeamFolder', () => {
        it('invokes createTeamFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateTeamFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateTeamFolderRequest', ['parent']);
    ...
    describe('updateTeamFolder', () => {
        it('invokes updateTeamFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateTeamFolderRequest()
            );
            request.teamFolder ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateTeamFolderRequest', ['teamFolder', 'name']);
    ...
    describe('deleteTeamFolder', () => {
        it('invokes deleteTeamFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteTeamFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteTeamFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getFolder', () => {
        it('invokes getFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Folder()
            );
        ...
        it('invokes getFolder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFolder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IFolder|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFolder', () => {
        it('invokes createFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateFolderRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Folder()
    ...
    describe('updateFolder', () => {
        it('invokes updateFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateFolderRequest()
            );
            request.folder ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateFolderRequest', ['folder', 'name']);
    ...
    describe('deleteFolder', () => {
        it('invokes deleteFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getRepository', () => {
        it('invokes getRepository without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetRepositoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetRepositoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Repository()
            );
        ...
        it('invokes getRepository without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRepository(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IRepository|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createRepository', () => {
        it('invokes createRepository without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateRepositoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateRepositoryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Repository()
    ...
    describe('updateRepository', () => {
        it('invokes updateRepository without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateRepositoryRequest()
            );
            request.repository ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateRepositoryRequest', ['repository', 'name']);
    ...
    describe('deleteRepository', () => {
        it('invokes deleteRepository without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteRepositoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteRepositoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('commitRepositoryChanges', () => {
        it('invokes commitRepositoryChanges without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CommitRepositoryChangesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CommitRepositoryChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CommitRepositoryChangesResponse()
            );
        ...
        it('invokes commitRepositoryChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.commitRepositoryChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICommitRepositoryChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readRepositoryFile', () => {
        it('invokes readRepositoryFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReadRepositoryFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ReadRepositoryFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReadRepositoryFileResponse()
            );
        ...
        it('invokes readRepositoryFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readRepositoryFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IReadRepositoryFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('computeRepositoryAccessTokenStatus', () => {
        it('invokes computeRepositoryAccessTokenStatus without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ComputeRepositoryAccessTokenStatusRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ComputeRepositoryAccessTokenStatusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ComputeRepositoryAccessTokenStatusResponse()
            );
        ...
        it('invokes computeRepositoryAccessTokenStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.computeRepositoryAccessTokenStatus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IComputeRepositoryAccessTokenStatusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchRemoteBranches', () => {
        it('invokes fetchRemoteBranches without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchRemoteBranchesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.FetchRemoteBranchesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchRemoteBranchesResponse()
            );
        ...
        it('invokes fetchRemoteBranches without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchRemoteBranches(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IFetchRemoteBranchesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getWorkspace', () => {
        it('invokes getWorkspace without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetWorkspaceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetWorkspaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Workspace()
            );
        ...
        it('invokes getWorkspace without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkspace(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IWorkspace|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWorkspace', () => {
        it('invokes createWorkspace without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateWorkspaceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateWorkspaceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Workspace()
    ...
    describe('deleteWorkspace', () => {
        it('invokes deleteWorkspace without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteWorkspaceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteWorkspaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('installNpmPackages', () => {
        it('invokes installNpmPackages without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.InstallNpmPackagesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.InstallNpmPackagesRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.InstallNpmPackagesResponse()
            );
        ...
        it('invokes installNpmPackages without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.installNpmPackages(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IInstallNpmPackagesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pullGitCommits', () => {
        it('invokes pullGitCommits without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.PullGitCommitsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.PullGitCommitsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.PullGitCommitsResponse()
            );
        ...
        it('invokes pullGitCommits without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.pullGitCommits(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IPullGitCommitsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pushGitCommits', () => {
        it('invokes pushGitCommits without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.PushGitCommitsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.PushGitCommitsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.PushGitCommitsResponse()
            );
        ...
        it('invokes pushGitCommits without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.pushGitCommits(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IPushGitCommitsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchFileGitStatuses', () => {
        it('invokes fetchFileGitStatuses without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchFileGitStatusesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.FetchFileGitStatusesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchFileGitStatusesResponse()
            );
        ...
        it('invokes fetchFileGitStatuses without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchFileGitStatuses(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IFetchFileGitStatusesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchGitAheadBehind', () => {
        it('invokes fetchGitAheadBehind without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchGitAheadBehindRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.FetchGitAheadBehindRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchGitAheadBehindResponse()
            );
        ...
        it('invokes fetchGitAheadBehind without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchGitAheadBehind(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IFetchGitAheadBehindResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('commitWorkspaceChanges', () => {
        it('invokes commitWorkspaceChanges without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CommitWorkspaceChangesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CommitWorkspaceChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CommitWorkspaceChangesResponse()
            );
        ...
        it('invokes commitWorkspaceChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.commitWorkspaceChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICommitWorkspaceChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('resetWorkspaceChanges', () => {
        it('invokes resetWorkspaceChanges without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ResetWorkspaceChangesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ResetWorkspaceChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ResetWorkspaceChangesResponse()
            );
        ...
        it('invokes resetWorkspaceChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.resetWorkspaceChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IResetWorkspaceChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchFileDiff', () => {
        it('invokes fetchFileDiff without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchFileDiffRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.FetchFileDiffRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchFileDiffResponse()
            );
        ...
        it('invokes fetchFileDiff without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchFileDiff(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IFetchFileDiffResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('makeDirectory', () => {
        it('invokes makeDirectory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MakeDirectoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.MakeDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MakeDirectoryResponse()
            );
        ...
        it('invokes makeDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.makeDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IMakeDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeDirectory', () => {
        it('invokes removeDirectory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.RemoveDirectoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.RemoveDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.RemoveDirectoryResponse()
            );
        ...
        it('invokes removeDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IRemoveDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveDirectory', () => {
        it('invokes moveDirectory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveDirectoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.MoveDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveDirectoryResponse()
            );
        ...
        it('invokes moveDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IMoveDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readFile', () => {
        it('invokes readFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReadFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ReadFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReadFileResponse()
            );
        ...
        it('invokes readFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IReadFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeFile', () => {
        it('invokes removeFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.RemoveFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.RemoveFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.RemoveFileResponse()
            );
        ...
        it('invokes removeFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IRemoveFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveFile', () => {
        it('invokes moveFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.MoveFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveFileResponse()
            );
        ...
        it('invokes moveFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IMoveFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeFile', () => {
        it('invokes writeFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WriteFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.WriteFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WriteFileResponse()
            );
        ...
        it('invokes writeFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IWriteFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getReleaseConfig', () => {
        it('invokes getReleaseConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetReleaseConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetReleaseConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReleaseConfig()
            );
        ...
        it('invokes getReleaseConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getReleaseConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IReleaseConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createReleaseConfig', () => {
        it('invokes createReleaseConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateReleaseConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateReleaseConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ReleaseConfig()
    ...
    describe('updateReleaseConfig', () => {
        it('invokes updateReleaseConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateReleaseConfigRequest()
            );
            request.releaseConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateReleaseConfigRequest', ['releaseConfig', 'name']);
    ...
    describe('deleteReleaseConfig', () => {
        it('invokes deleteReleaseConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteReleaseConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteReleaseConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getCompilationResult', () => {
        it('invokes getCompilationResult without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetCompilationResultRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetCompilationResultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CompilationResult()
            );
        ...
        it('invokes getCompilationResult without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCompilationResult(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICompilationResult|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCompilationResult', () => {
        it('invokes createCompilationResult without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateCompilationResultRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateCompilationResultRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CompilationResult()
    ...
    describe('getWorkflowConfig', () => {
        it('invokes getWorkflowConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetWorkflowConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetWorkflowConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WorkflowConfig()
            );
        ...
        it('invokes getWorkflowConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkflowConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IWorkflowConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWorkflowConfig', () => {
        it('invokes createWorkflowConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateWorkflowConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateWorkflowConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WorkflowConfig()
    ...
    describe('updateWorkflowConfig', () => {
        it('invokes updateWorkflowConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateWorkflowConfigRequest()
            );
            request.workflowConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateWorkflowConfigRequest', ['workflowConfig', 'name']);
    ...
    describe('deleteWorkflowConfig', () => {
        it('invokes deleteWorkflowConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteWorkflowConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteWorkflowConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getWorkflowInvocation', () => {
        it('invokes getWorkflowInvocation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetWorkflowInvocationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WorkflowInvocation()
            );
        ...
        it('invokes getWorkflowInvocation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkflowInvocation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IWorkflowInvocation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWorkflowInvocation', () => {
        it('invokes createWorkflowInvocation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CreateWorkflowInvocationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CreateWorkflowInvocationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.WorkflowInvocation()
    ...
    describe('deleteWorkflowInvocation', () => {
        it('invokes deleteWorkflowInvocation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteWorkflowInvocationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('cancelWorkflowInvocation', () => {
        it('invokes cancelWorkflowInvocation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CancelWorkflowInvocationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.CancelWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.CancelWorkflowInvocationResponse()
            );
        ...
        it('invokes cancelWorkflowInvocation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.cancelWorkflowInvocation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICancelWorkflowInvocationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConfig', () => {
        it('invokes getConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.GetConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.GetConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1.Config()
            );
        ...
        it('invokes getConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateConfig', () => {
        it('invokes updateConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.UpdateConfigRequest()
            );
            request.config ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.UpdateConfigRequest', ['config', 'name']);
    ...
    describe('deleteTeamFolderTree', () => {
        it('invokes deleteTeamFolderTree without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteTeamFolderTreeRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteTeamFolderTreeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteTeamFolderTree = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteTeamFolderTree(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTeamFolderTree as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTeamFolderTree as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTeamFolderTree without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTeamFolderTree = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteTeamFolderTree(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IDeleteFolderTreeMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IDeleteFolderTreeMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTeamFolderTree as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteTeamFolderTree with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTeamFolderTree = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteTeamFolderTree with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTeamFolderTree = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteTeamFolderTree(request);
        ...
        it('invokes checkDeleteTeamFolderTreeProgress without error', async () => {
            ...
            const decodedOperation = await client.checkDeleteTeamFolderTreeProgress(expectedResponse.name);
        ...
        it('invokes checkDeleteTeamFolderTreeProgress with error', async () => {
            ...
            await assert.rejects(client.checkDeleteTeamFolderTreeProgress(''), expectedError);
    ...
    describe('deleteFolderTree', () => {
        it('invokes deleteFolderTree without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.DeleteFolderTreeRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.DeleteFolderTreeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFolderTree = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFolderTree(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFolderTree as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFolderTree as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFolderTree without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFolderTree = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteFolderTree with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolderTree = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteFolderTree with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolderTree = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFolderTree(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFolderTree as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFolderTreeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFolderTreeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFolderTreeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFolderTreeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('moveFolder', () => {
        it('invokes moveFolder without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveFolderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.MoveFolderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes moveFolder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IMoveFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IMoveFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.moveFolder as SinonStub)
                .getCall(0).args[0];
    ...
    describe('moveRepository', () => {
        it('invokes moveRepository without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.MoveRepositoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.MoveRepositoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes moveRepository without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveRepository(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IMoveRepositoryMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataform.v1.IMoveRepositoryMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.moveRepository as SinonStub)
                .getCall(0).args[0];
    ...
    describe('queryTeamFolderContents', () => {
        it('invokes queryTeamFolderContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryTeamFolderContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryTeamFolderContentsRequest', ['teamFolder']);
            request.teamFolder = defaultValue1;
            const expectedHeaderRequestParams = `team_folder=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry()),
            ];
        ...
        it('invokes queryTeamFolderContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryTeamFolderContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.ITeamFolderContentsEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryTeamFolderContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry) => {
        ...
        it('uses async iteration with queryTeamFolderContents without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.QueryTeamFolderContentsResponse.ITeamFolderContentsEntry[] = [];
    ...
    describe('searchTeamFolders', () => {
        it('invokes searchTeamFolders without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.SearchTeamFoldersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.SearchTeamFoldersRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.TeamFolderSearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.TeamFolderSearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.TeamFolderSearchResult()),
            ];
        ...
        it('invokes searchTeamFolders without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchTeamFolders(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.ITeamFolderSearchResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchTeamFoldersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.TeamFolderSearchResult[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.TeamFolderSearchResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with searchTeamFolders without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.SearchTeamFoldersResponse.ITeamFolderSearchResult[] = [];
    ...
    describe('queryFolderContents', () => {
        it('invokes queryFolderContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryFolderContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryFolderContentsRequest', ['folder']);
            request.folder = defaultValue1;
            const expectedHeaderRequestParams = `folder=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryFolderContentsResponse.FolderContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryFolderContentsResponse.FolderContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryFolderContentsResponse.FolderContentsEntry()),
            ];
        ...
        it('invokes queryFolderContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryFolderContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.QueryFolderContentsResponse.IFolderContentsEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryFolderContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.QueryFolderContentsResponse.FolderContentsEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.QueryFolderContentsResponse.FolderContentsEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryFolderContents without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.QueryFolderContentsResponse.IFolderContentsEntry[] = [];
    ...
    describe('queryUserRootContents', () => {
        it('invokes queryUserRootContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryUserRootContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryUserRootContentsRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.RootContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.RootContentsEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.RootContentsEntry()),
            ];
        ...
        it('invokes queryUserRootContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryUserRootContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.IRootContentsEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryUserRootContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.RootContentsEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.RootContentsEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryUserRootContents without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.QueryUserRootContentsResponse.IRootContentsEntry[] = [];
    ...
    describe('listRepositories', () => {
        it('invokes listRepositories without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListRepositoriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListRepositoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.Repository()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.Repository()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.Repository()),
            ];
        ...
        it('invokes listRepositoriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.Repository[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.Repository) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listRepositories without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IRepository[] = [];
    ...
    describe('queryRepositoryDirectoryContents', () => {
        it('invokes queryRepositoryDirectoryContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryRepositoryDirectoryContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryRepositoryDirectoryContentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.DirectoryEntry()),
            ];
        ...
        it('invokes queryRepositoryDirectoryContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryRepositoryDirectoryContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IDirectoryEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryRepositoryDirectoryContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.DirectoryEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.DirectoryEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryRepositoryDirectoryContents without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IDirectoryEntry[] = [];
    ...
    describe('fetchRepositoryHistory', () => {
        it('invokes fetchRepositoryHistory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.FetchRepositoryHistoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.FetchRepositoryHistoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.CommitLogEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CommitLogEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CommitLogEntry()),
            ];
        ...
        it('invokes fetchRepositoryHistory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchRepositoryHistory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICommitLogEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchRepositoryHistoryStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.CommitLogEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.CommitLogEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with fetchRepositoryHistory without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.ICommitLogEntry[] = [];
    ...
    describe('listWorkspaces', () => {
        it('invokes listWorkspaces without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListWorkspacesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListWorkspacesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.Workspace()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.Workspace()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.Workspace()),
            ];
        ...
        it('invokes listWorkspacesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.Workspace[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.Workspace) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listWorkspaces without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IWorkspace[] = [];
    ...
    describe('queryDirectoryContents', () => {
        it('invokes queryDirectoryContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryDirectoryContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryDirectoryContentsRequest', ['workspace']);
            request.workspace = defaultValue1;
    ...
    describe('searchFiles', () => {
        it('invokes searchFiles without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.SearchFilesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.SearchFilesRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.SearchResult()),
            ];
        ...
        it('invokes searchFiles without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchFiles(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ISearchResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchFilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.SearchResult[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.SearchResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with searchFiles without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.ISearchResult[] = [];
    ...
    describe('listReleaseConfigs', () => {
        it('invokes listReleaseConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListReleaseConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListReleaseConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.ReleaseConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.ReleaseConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.ReleaseConfig()),
            ];
        ...
        it('invokes listReleaseConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.ReleaseConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.ReleaseConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listReleaseConfigs without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IReleaseConfig[] = [];
    ...
    describe('listCompilationResults', () => {
        it('invokes listCompilationResults without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListCompilationResultsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListCompilationResultsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResult()),
            ];
        ...
        it('invokes listCompilationResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.CompilationResult[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.CompilationResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listCompilationResults without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.ICompilationResult[] = [];
    ...
    describe('queryCompilationResultActions', () => {
        it('invokes queryCompilationResultActions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryCompilationResultActionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryCompilationResultActionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResultAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResultAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.CompilationResultAction()),
            ];
        ...
        it('invokes queryCompilationResultActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryCompilationResultActions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.ICompilationResultAction[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryCompilationResultActionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.CompilationResultAction[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.CompilationResultAction) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryCompilationResultActions without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.ICompilationResultAction[] = [];
    ...
    describe('listWorkflowConfigs', () => {
        it('invokes listWorkflowConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListWorkflowConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListWorkflowConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowConfig()),
            ];
        ...
        it('invokes listWorkflowConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.WorkflowConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.WorkflowConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listWorkflowConfigs without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IWorkflowConfig[] = [];
    ...
    describe('listWorkflowInvocations', () => {
        it('invokes listWorkflowInvocations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.ListWorkflowInvocationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.ListWorkflowInvocationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocation()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocation()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocation()),
            ];
        ...
        it('invokes listWorkflowInvocationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.WorkflowInvocation[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.WorkflowInvocation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listWorkflowInvocations without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IWorkflowInvocation[] = [];
    ...
    describe('queryWorkflowInvocationActions', () => {
        it('invokes queryWorkflowInvocationActions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataform.v1.QueryWorkflowInvocationActionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1.QueryWorkflowInvocationActionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocationAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocationAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1.WorkflowInvocationAction()),
            ];
        ...
        it('invokes queryWorkflowInvocationActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryWorkflowInvocationActions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1.IWorkflowInvocationAction[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryWorkflowInvocationActionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1.WorkflowInvocationAction[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1.WorkflowInvocationAction) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryWorkflowInvocationActions without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1.IWorkflowInvocationAction[] = [];
